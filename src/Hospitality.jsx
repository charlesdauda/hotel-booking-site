...
// Reusable shine blade — slot it inside any group-relative-overflow-hidden wrapper
const Shine = () => (
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="relative">
          ...
          {/* Quote card — overlaps bottom of image on desktop, stacks under on mobile */}
        ...
        {/* ============ RIGHT: text content + features + thumbnails ============ */}
        <div>
          {/* Eyebrow */}
