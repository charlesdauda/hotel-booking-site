        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {rooms.map((room, i) => (
            ...
            >
              ...
              {/* Title + price (lifts up on hover) */}
              <div className="absolute inset-x-0 bottom-0 p-6 lg:p-8 text-right transition-transform duration-500 ease-out group-hover:-translate-y-14">
              ...
              {/* Action row — fades in at bottom on hover */}
              <div className="absolute inset-x-0 bottom-0 px-6 lg:px-8 pb-6 lg:pb-7 flex items-center justify-between opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                <button className="border border-white/80 text-white text-[11px] tracking-[0.2em] px-6 py-3 hover:bg-[#bf9b6a] hover:border-[#bf9b6a] transition-colors">
                  BOOK NOW
                </button>
